...
import (
	...
	"github.com/ashkan-rezaei-tsh/slipgate/internal/menu"
	"github.com/ashkan-rezaei-tsh/slipgate/internal/version"
	"github.com/spf13/cobra"

	// Register all actions
	_ "github.com/ashkan-rezaei-tsh/slipgate/internal/actions"
)

var rootCmd = &cobra.Command{
	Use:   "slipgate",
	Short: "Unified server tunnel manager",
	Long:  "SlipGate manages DNS tunnels (DNSTT, NoizDNS, Slipstream, VayDNS, MasterDNS) and HTTPS proxies (NaiveProxy) with systemd services.",
